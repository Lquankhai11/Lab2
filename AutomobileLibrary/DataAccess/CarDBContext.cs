    ...
    public class CarDBContext : BaseDAL
    {
        ...
        public void AddNew(Car car)
        {
            try
            {
                ...
                if (pro != null)
                {
                    string SQLSelect = "Insert Cars values(@CarID,@CarName,@Manufacturer,@Price,@ReleaseYear)";
        ...
        public void Update(Car car)
        {
            try
            {
                ...
                if (c != null)
                {
                    string SQLSelect = "Update Cars set CarName = @CaarName, Manufacturer = @Manufacturer," +
                    ...
                    parameters.Add(dataProvider.CreateParameter("@Price", 50, car.Price, DbType.Decimal));
                    parameters.Add(dataProvider.CreateParameter("@ReleaseYear", 4, car.ReleaseYear, DbType.Int32));
                    dataProvider.Update(SQLSelect, CommandType.Text, parameters.ToArray());
                }
                else
                {
